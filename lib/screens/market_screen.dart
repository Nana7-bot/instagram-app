...
import 'package:instagram_ui/reusable_widget/custom_text_field.dart';
              ...
              child: Column(
                children: [
                  ...
                  CustomTextField(
                    ...
                    searchPrefixIcon: Icon(Icons.search),
                  ),
                ],
              ),
            ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage("images/${_dataInfo.marketItems[index]["item1Image"]}"),
                            fit: BoxFit.cover),
                      ),
                    ),
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage("images/${_dataInfo.marketItems[index]["item2Image"]}"),
                            fit: BoxFit.cover),
                      ),
                    )
                  ],
